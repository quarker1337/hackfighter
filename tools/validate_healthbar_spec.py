...
checks = [
    ...
    root / 'assets' / 'ui' / 'hero_profile_lobster.png',
    root / 'assets' / 'ui' / 'hero_profile_lobster_p2.png',
    root / 'assets' / 'ui' / 'hero_profile_scanlines.png',
    root / 'assets' / 'ui' / 'hero_profile_scanlines_p2.png',
    root / 'assets' / 'ui' / 'hero_profile_top.png',
    root / 'assets' / 'ui' / 'hero_profile_top_p2.png',
...
required_health = [
    ...
    '_hero_profile_path(hero_name, suffix)', 'hero_profile_lobster%s.png',
    ...
    'hero_profile_scanlines%s.png', 'hero_profile_top%s.png', 'PortraitScanlineClip', 'clip_contents = true',
...
expected_sizes = {
    ...
    'assets/ui/hero_profile_lobster.png': (151, 152),
    'assets/ui/hero_profile_lobster_p2.png': (151, 152),
    'assets/ui/hero_profile_scanlines.png': (151, 152),
    'assets/ui/hero_profile_scanlines_p2.png': (151, 152),
    'assets/ui/hero_profile_top.png': (151, 152),
    'assets/ui/hero_profile_top_p2.png': (151, 152),
